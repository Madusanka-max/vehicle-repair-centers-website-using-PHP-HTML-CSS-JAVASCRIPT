...
$sql = "INSERT INTO booking (first, last, vehicle_type, services, branch, date_time, phone, vehicle_number, other) 
        VALUES ('$first', '$last', '$vehicle_type', '$services', '$branch', '$date_time', '$phone', '$vehicle_number', '$other')";
